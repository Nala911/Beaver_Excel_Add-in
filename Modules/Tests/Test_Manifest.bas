...
Public Sub RunGeneratedTests(Optional ByVal filterPattern As String = "")
    ...
    If MatchesFilter("Test_Feat_CreateNamedRanges.Test_CreateNamedRanges_ApplyNames", filterPattern) Then Test_Feat_CreateNamedRanges.Test_CreateNamedRanges_ApplyNames
    If MatchesFilter("Test_Feat_CreateNamedRanges.Test_CreateNamedRanges_EmptyValueSkipping", filterPattern) Then Test_Feat_CreateNamedRanges.Test_CreateNamedRanges_EmptyValueSkipping
    ...
    If MatchesFilter("Test_Feat_CreateNamedRanges.Test_CreateNamedRanges_FullColumnOptimized", filterPattern) Then Test_Feat_CreateNamedRanges.Test_CreateNamedRanges_FullColumnOptimized
