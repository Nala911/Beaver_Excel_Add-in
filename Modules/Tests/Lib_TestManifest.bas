...
Public Sub RunGeneratedTests(Optional ByVal filterPattern As String = "")
    ...
    If MatchesFilter("Lib_Tests_Feat_CleanData.Test_CleanData_NewEnhancements", filterPattern) Then Lib_Tests_Feat_CleanData.Test_CleanData_NewEnhancements
    If MatchesFilter("Lib_Tests_Feat_CleanData.Test_CleanData_TrimmingAndNumericalFixing", filterPattern) Then Lib_Tests_Feat_CleanData.Test_CleanData_TrimmingAndNumericalFixing
    If MatchesFilter("Lib_Tests_Feat_CleanData.Test_CleanData_UserRequestedEnhancements", filterPattern) Then Lib_Tests_Feat_CleanData.Test_CleanData_UserRequestedEnhancements
    If MatchesFilter("Lib_Tests_Feat_CleanData.Test_ForceNumber_Execution_And_Undo", filterPattern) Then Lib_Tests_Feat_CleanData.Test_ForceNumber_Execution_And_Undo
    If MatchesFilter("Lib_Tests_Feat_CleanData.Test_TryConvertToNumber_Unification", filterPattern) Then Lib_Tests_Feat_CleanData.Test_TryConvertToNumber_Unification
    If MatchesFilter("Lib_Tests_Feat_CleanData.Test_UnifiedHelpers_And_CleanDataDisjoint", filterPattern) Then Lib_Tests_Feat_CleanData.Test_UnifiedHelpers_And_CleanDataDisjoint
    If MatchesFilter("Lib_Tests_Feat_CleanData.Test_UnmergeFill_Execution_And_Undo", filterPattern) Then Lib_Tests_Feat_CleanData.Test_UnmergeFill_Execution_And_Undo
    If MatchesFilter("Lib_Tests_Feat_Editing.Test_Backspace_LargeRange_Undo", filterPattern) Then Lib_Tests_Feat_Editing.Test_Backspace_LargeRange_Undo
    If MatchesFilter("Lib_Tests_Feat_Editing.Test_Delete_Execution_And_Undo", filterPattern) Then Lib_Tests_Feat_Editing.Test_Delete_Execution_And_Undo
    If MatchesFilter("Lib_Tests_Feat_Editing.Test_FillDown_Features", filterPattern) Then Lib_Tests_Feat_Editing.Test_FillDown_Features
